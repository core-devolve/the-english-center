...
const steps = [
  { icon: "📝", title: "Fill the Form",     desc: "Submit your enquiry with your details and schedule preference." },
  { icon: "📞", title: "Counselling Call",  desc: "Our team calls you within 24 hours to understand your goals." },
  { icon: "💳", title: "Pay & Confirm",     desc: "Complete your payment securely online and get instant confirmation." },
  { icon: "🚀", title: "Start Learning",    desc: "Get your login credentials and begin your first class on schedule." },
];
  ...
  return (
    <>
      <style>{`
        ...
        .ap-section-eyebrow { display:inline-flex; align-items:center; gap:8px; font-family:'Syne',sans-serif; font-size:10px; font-weight:700; color:#4f46e5; text-transform:uppercase; letter-spacing:2px; margin-bottom:10px; }
        ...
        .ap-step {
          ...
          border:1px solid rgba(79,70,229,0.08); box-shadow:0 3px 14px rgba(0,0,0,0.06);
        ...
        .ap-step-title { font-family:'Syne',sans-serif; font-size:14px; font-weight:800; color:#0f0c29; margin-bottom:6px; }
        .ap-step-desc { font-size:12px; color:#6b7280; line-height:1.6; }
        .ap-step-connector { position:absolute; right:-20px; top:50%; transform:translateY(-50%); width:24px; height:2px; background:linear-gradient(90deg,#c4b5fd,#a78bfa); border-radius:2px; z-index:1; }
        ...
        .ap-field-label { font-family:'Syne',sans-serif; font-size:11px; font-weight:700; color:#374151; text-transform:uppercase; letter-spacing:0.8px; margin-bottom:6px; display:block; }
        .ap-field-label span { color:#ef4444; }
        .ap-input, .ap-select, .ap-textarea {
          width:100%; background:#f8f7ff; border:1.5px solid #e5e7eb;
          color:#0f0c29; border-radius:10px; padding:11px 14px; font-size:13px;
          font-family:'DM Sans',sans-serif; outline:none;
          transition:border-color 0.2s, box-shadow 0.2s; -webkit-appearance:none; appearance:none;
        }
        .ap-input:focus, .ap-select:focus, .ap-textarea:focus { border-color:#4f46e5; box-shadow:0 0 0 3px rgba(79,70,229,0.1); }
        ...
        .ap-error { font-size:12px; color:#ef4444; background:rgba(239,68,68,0.06); border:1px solid rgba(239,68,68,0.2); border-radius:8px; padding:10px 14px; margin-bottom:4px; }
        ...
        .ap-submit-btn {
          ...
          cursor:pointer; box-shadow:0 6px 20px rgba(79,70,229,0.38);
        ...
        .ap-success-btn {
          margin-top:20px; background:linear-gradient(135deg,#4f46e5,#7c3aed); color:#fff;
        ...
        .ap-benefit-name { font-family:'Syne',sans-serif; font-size:13px; font-weight:700; color:#0f0c29; margin-bottom:2px; }
        ...
        .ap-faq-q-text { font-family:'Syne',sans-serif; font-size:14px; font-weight:700; color:#0f0c29; line-height:1.3; }
        ...
        .ap-faq-a { padding:14px 20px 16px; font-size:13px; color:#6b7280; line-height:1.7; border-top:1px solid #f1f5f9; }
        ...
        @media (max-width:480px) { .ap-steps-grid { grid-template-columns:1fr; } }
      `}</style>
              ...
              {!submitted ? (
                <>
                  ...
                  <div className="ap-form-grid">
                    ...
                    {error && <div className="ap-form-full"><div className="ap-error">⚠️ {error}</div></div>}
                    <div className="ap-form-full">
                      <button className="ap-submit-btn" onClick={handleSubmit} disabled={loading}>
                        {loading ? <><div className="ap-spinner-sm" /> Submitting…</> : "Submit Enquiry →"}
                      </button>
